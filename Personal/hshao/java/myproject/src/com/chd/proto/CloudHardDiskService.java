...
public class CloudHardDiskService {
  ...
  public interface Iface {
    ...
    public int testsum(int sum1, int sum2) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void testsum(int sum1, int sum2, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public int testsum(int sum1, int sum2) throws org.apache.thrift.TException
    {
      send_testsum(sum1, sum2);
      return recv_testsum();
    }

    public void send_testsum(int sum1, int sum2) throws org.apache.thrift.TException
    {
      testsum_args args = new testsum_args();
      args.setSum1(sum1);
      args.setSum2(sum2);
      sendBase("testsum", args);
    }

    public int recv_testsum() throws org.apache.thrift.TException
    {
      testsum_result result = new testsum_result();
      receiveBase(result, "testsum");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "testsum failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void testsum(int sum1, int sum2, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      testsum_call method_call = new testsum_call(sum1, sum2, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class testsum_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int sum1;
      private int sum2;
      public testsum_call(int sum1, int sum2, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.sum1 = sum1;
        this.sum2 = sum2;
      }
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("testsum", org.apache.thrift.protocol.TMessageType.CALL, 0));
        testsum_args args = new testsum_args();
        args.setSum1(sum1);
        args.setSum2(sum2);
        args.write(prot);
      ...
      public int getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_testsum();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("testsum", new testsum());
      return processMap;
    }
    ...
    public static class testsum<I extends Iface> extends org.apache.thrift.ProcessFunction<I, testsum_args> {
      public testsum() {
        super("testsum");
      }

      public testsum_args getEmptyArgsInstance() {
        return new testsum_args();
      }
      ...
      public testsum_result getResult(I iface, testsum_args args) throws org.apache.thrift.TException {
        testsum_result result = new testsum_result();
        result.success = iface.testsum(args.sum1, args.sum2);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class testsum<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, testsum_args, Integer> {
      public testsum() {
        super("testsum");
      }
      ...
      public void start(I iface, testsum_args args, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws TException {
        iface.testsum(args.sum1, args.sum2,resultHandler);
      }
    }
  ...
  public static class testsum_args implements org.apache.thrift.TBase<testsum_args, testsum_args._Fields>, java.io.Serializable, Cloneable, Comparable<testsum_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("testsum_args");

    private static final org.apache.thrift.protocol.TField SUM1_FIELD_DESC = new org.apache.thrift.protocol.TField("sum1", org.apache.thrift.protocol.TType.I32, (short)1);
    private static final org.apache.thrift.protocol.TField SUM2_FIELD_DESC = new org.apache.thrift.protocol.TField("sum2", org.apache.thrift.protocol.TType.I32, (short)2);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new testsum_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new testsum_argsTupleSchemeFactory());
    }

    public int sum1; // required
    public int sum2; // required
    ...
    // isset id assignments
    private static final int __SUM1_ISSET_ID = 0;
    private static final int __SUM2_ISSET_ID = 1;
    private byte __isset_bitfield = 0;
    public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUM1, new org.apache.thrift.meta_data.FieldMetaData("sum1", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
      tmpMap.put(_Fields.SUM2, new org.apache.thrift.meta_data.FieldMetaData("sum2", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(testsum_args.class, metaDataMap);
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public testsum_args(testsum_args other) {
      __isset_bitfield = other.__isset_bitfield;
      this.sum1 = other.sum1;
      this.sum2 = other.sum2;
    }

    public testsum_args deepCopy() {
      return new testsum_args(this);
    }
    ...
    public testsum_args setSum1(int sum1) {
      this.sum1 = sum1;
      setSum1IsSet(true);
      return this;
    }

    public void unsetSum1() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SUM1_ISSET_ID);
    }

    /** Returns true if field sum1 is set (has been assigned a value) and false otherwise */
    public boolean isSetSum1() {
      return EncodingUtils.testBit(__isset_bitfield, __SUM1_ISSET_ID);
    }

    public void setSum1IsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SUM1_ISSET_ID, value);
    }
    ...
    public testsum_args setSum2(int sum2) {
      this.sum2 = sum2;
      setSum2IsSet(true);
      return this;
    }

    public void unsetSum2() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SUM2_ISSET_ID);
    }

    /** Returns true if field sum2 is set (has been assigned a value) and false otherwise */
    public boolean isSetSum2() {
      return EncodingUtils.testBit(__isset_bitfield, __SUM2_ISSET_ID);
    }

    public void setSum2IsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SUM2_ISSET_ID, value);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof testsum_args)
        return this.equals((testsum_args)that);
      return false;
    }

    public boolean equals(testsum_args that) {
      if (that == null)
        return false;

      boolean this_present_sum1 = true;
      boolean that_present_sum1 = true;
      if (this_present_sum1 || that_present_sum1) {
        if (!(this_present_sum1 && that_present_sum1))
          return false;
        if (this.sum1 != that.sum1)
          return false;
      }

      boolean this_present_sum2 = true;
      boolean that_present_sum2 = true;
      if (this_present_sum2 || that_present_sum2) {
        if (!(this_present_sum2 && that_present_sum2))
          return false;
        if (this.sum2 != that.sum2)
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_sum1 = true;
      list.add(present_sum1);
      if (present_sum1)
        list.add(sum1);

      boolean present_sum2 = true;
      list.add(present_sum2);
      if (present_sum2)
        list.add(sum2);
    ...
    @Override
    public int compareTo(testsum_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
      ...
      lastComparison = Boolean.valueOf(isSetSum1()).compareTo(other.isSetSum1());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetSum1()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sum1, other.sum1);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
      lastComparison = Boolean.valueOf(isSetSum2()).compareTo(other.isSetSum2());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetSum2()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sum2, other.sum2);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("testsum_args(");
      boolean first = true;
    ...
    private static class testsum_argsStandardSchemeFactory implements SchemeFactory {
      public testsum_argsStandardScheme getScheme() {
        return new testsum_argsStandardScheme();
      }
    }

    private static class testsum_argsStandardScheme extends StandardScheme<testsum_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, testsum_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // SUM1
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.sum1 = iprot.readI32();
                struct.setSum1IsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
            case 2: // SUM2
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.sum2 = iprot.readI32();
                struct.setSum2IsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, testsum_args struct) throws org.apache.thrift.TException {
        struct.validate();

        oprot.writeStructBegin(STRUCT_DESC);
        oprot.writeFieldBegin(SUM1_FIELD_DESC);
        oprot.writeI32(struct.sum1);
        oprot.writeFieldEnd();
        oprot.writeFieldBegin(SUM2_FIELD_DESC);
        oprot.writeI32(struct.sum2);
        oprot.writeFieldEnd();
        oprot.writeFieldStop();
        oprot.writeStructEnd();
      }
    ...
    private static class testsum_argsTupleSchemeFactory implements SchemeFactory {
      public testsum_argsTupleScheme getScheme() {
        return new testsum_argsTupleScheme();
      }
    }

    private static class testsum_argsTupleScheme extends TupleScheme<testsum_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, testsum_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSum1()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, testsum_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.sum1 = iprot.readI32();
  ...
  public static class testsum_result implements org.apache.thrift.TBase<testsum_result, testsum_result._Fields>, java.io.Serializable, Cloneable, Comparable<testsum_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("testsum_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.I32, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new testsum_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new testsum_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(testsum_result.class, metaDataMap);
    }

    public testsum_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public testsum_result(testsum_result other) {
      __isset_bitfield = other.__isset_bitfield;
      this.success = other.success;
    }

    public testsum_result deepCopy() {
      return new testsum_result(this);
    }
    ...
    public testsum_result setSuccess(int success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof testsum_result)
        return this.equals((testsum_result)that);
      return false;
    }

    public boolean equals(testsum_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(testsum_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("testsum_result(");
      boolean first = true;
    ...
    private static class testsum_resultStandardSchemeFactory implements SchemeFactory {
      public testsum_resultStandardScheme getScheme() {
        return new testsum_resultStandardScheme();
      }
    }

    private static class testsum_resultStandardScheme extends StandardScheme<testsum_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, testsum_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, testsum_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class testsum_resultTupleSchemeFactory implements SchemeFactory {
      public testsum_resultTupleScheme getScheme() {
        return new testsum_resultTupleScheme();
      }
    }

    private static class testsum_resultTupleScheme extends TupleScheme<testsum_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, testsum_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, testsum_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readI32();
