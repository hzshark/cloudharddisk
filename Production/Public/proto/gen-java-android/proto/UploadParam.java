...
public class UploadParam implements org.apache.thrift.TBase<UploadParam, UploadParam._Fields>, java.io.Serializable, Cloneable, Comparable<UploadParam>, android.os.Parcelable {
  ...
  public UploadParam(android.os.Parcel in) {
    //primitive bitfield of type: byte
    __isset_bitfield = in.readByte();

    this.filename= in.readString();
    this.offerstar = in.readLong();
    if(in.readInt()==1) {
      this.bin = ByteBuffer.wrap(in.createByteArray());
    }
  }

  public static final android.os.Parcelable.Creator<UploadParam> CREATOR = new android.os.Parcelable.Creator<UploadParam>() {
    @Override
    ...
    @Override
    public UploadParam createFromParcel(android.os.Parcel in) {
