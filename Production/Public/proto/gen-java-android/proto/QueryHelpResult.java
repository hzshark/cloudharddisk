...
public class QueryHelpResult implements org.apache.thrift.TBase<QueryHelpResult, QueryHelpResult._Fields>, java.io.Serializable, Cloneable, Comparable<QueryHelpResult>, android.os.Parcelable {
  ...
  public QueryHelpResult(android.os.Parcel in) {
    this.result= in.readParcelable(QueryHelpResult.class.getClassLoader());
    this.msg = new ArrayList<String>();
    in.readList(this.msg, QueryHelpResult.class.getClassLoader());
  }

  public static final android.os.Parcelable.Creator<QueryHelpResult> CREATOR = new android.os.Parcelable.Creator<QueryHelpResult>() {
    @Override
    public QueryHelpResult[] newArray(int size) {
      return new QueryHelpResult[size];
    }

    @Override
    public QueryHelpResult createFromParcel(android.os.Parcel in) {
      return new QueryHelpResult(in);
    }
  };
