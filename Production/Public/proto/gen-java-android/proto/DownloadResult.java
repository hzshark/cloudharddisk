...
public class DownloadResult implements org.apache.thrift.TBase<DownloadResult, DownloadResult._Fields>, java.io.Serializable, Cloneable, Comparable<DownloadResult>, android.os.Parcelable {
  ...
  public DownloadResult(android.os.Parcel in) {
    this.result= in.readParcelable(DownloadResult.class.getClassLoader());
    if(in.readInt()==1) {
      this.bin = ByteBuffer.wrap(in.createByteArray());
    }
  }

  public static final android.os.Parcelable.Creator<DownloadResult> CREATOR = new android.os.Parcelable.Creator<DownloadResult>() {
    @Override
    ...
    @Override
    public DownloadResult createFromParcel(android.os.Parcel in) {
