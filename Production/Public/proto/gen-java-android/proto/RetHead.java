...
public class RetHead implements org.apache.thrift.TBase<RetHead, RetHead._Fields>, java.io.Serializable, Cloneable, Comparable<RetHead>, android.os.Parcelable {
  ...
  public RetHead(android.os.Parcel in) {
    this.ret = Errcode.findByValue(in.readInt());
    this.msg= in.readString();
  }

  public static final android.os.Parcelable.Creator<RetHead> CREATOR = new android.os.Parcelable.Creator<RetHead>() {
    @Override
    public RetHead[] newArray(int size) {
      return new RetHead[size];
    }

    @Override
    public RetHead createFromParcel(android.os.Parcel in) {
      return new RetHead(in);
    }
  };
