...
public class UploaddResult implements org.apache.thrift.TBase<UploaddResult, UploaddResult._Fields>, java.io.Serializable, Cloneable, Comparable<UploaddResult>, android.os.Parcelable {
  ...
  public UploaddResult(android.os.Parcel in) {
    this.result= in.readParcelable(UploaddResult.class.getClassLoader());
  }

  public static final android.os.Parcelable.Creator<UploaddResult> CREATOR = new android.os.Parcelable.Creator<UploaddResult>() {
    @Override
    public UploaddResult[] newArray(int size) {
      return new UploaddResult[size];
    }

    @Override
    public UploaddResult createFromParcel(android.os.Parcel in) {
      return new UploaddResult(in);
    }
  };
