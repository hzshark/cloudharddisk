...
public class CaptchaResult implements org.apache.thrift.TBase<CaptchaResult, CaptchaResult._Fields>, java.io.Serializable, Cloneable, Comparable<CaptchaResult>, android.os.Parcelable {
  ...
  public CaptchaResult(android.os.Parcel in) {
    this.result= in.readParcelable(CaptchaResult.class.getClassLoader());
    this.captcha= in.readString();
  }

  public static final android.os.Parcelable.Creator<CaptchaResult> CREATOR = new android.os.Parcelable.Creator<CaptchaResult>() {
    @Override
    ...
    @Override
    public CaptchaResult createFromParcel(android.os.Parcel in) {
