...
public class QueryFListResult implements org.apache.thrift.TBase<QueryFListResult, QueryFListResult._Fields>, java.io.Serializable, Cloneable, Comparable<QueryFListResult>, android.os.Parcelable {
  ...
  private static final org.apache.thrift.protocol.TField IS_END_FIELD_DESC = new org.apache.thrift.protocol.TField("isEnd", org.apache.thrift.protocol.TType.BOOL, (short)4);
  ...
  public QueryFListResult(android.os.Parcel in) {
    //primitive bitfield of type: byte
    __isset_bitfield = in.readByte();

    this.result= in.readParcelable(QueryFListResult.class.getClassLoader());
    this.files = new ArrayList<FileInfo>();
    in.readTypedList(this.files, FileInfo.CREATOR);
    this.spare = in.readInt();
    this.isEnd = (in.readInt()==1);
  }

  public static final android.os.Parcelable.Creator<QueryFListResult> CREATOR = new android.os.Parcelable.Creator<QueryFListResult>() {
    @Override
    public QueryFListResult[] newArray(int size) {
      return new QueryFListResult[size];
    }

    @Override
    public QueryFListResult createFromParcel(android.os.Parcel in) {
      return new QueryFListResult(in);
    }
  };
  ...
  private static final int __ISEND_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.FILES,_Fields.SPARE,_Fields.IS_END};
  ...
  static {
    ...
    tmpMap.put(_Fields.IS_END, new org.apache.thrift.meta_data.FieldMetaData("isEnd", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public QueryFListResult setIsEnd(boolean isEnd) {
    this.isEnd = isEnd;
    setIsEndIsSet(true);
    return this;
  }
  ...
  public boolean equals(QueryFListResult that) {
    ...
    boolean this_present_isEnd = true && this.isSetIsEnd();
    boolean that_present_isEnd = true && that.isSetIsEnd();
  ...
  public int hashCode() {
    ...
    boolean present_isEnd = true && (isSetIsEnd());
