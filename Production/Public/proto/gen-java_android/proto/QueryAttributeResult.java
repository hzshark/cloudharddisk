...
public class QueryAttributeResult implements org.apache.thrift.TBase<QueryAttributeResult, QueryAttributeResult._Fields>, java.io.Serializable, Cloneable, Comparable<QueryAttributeResult>, android.os.Parcelable {
  ...
  public QueryAttributeResult(android.os.Parcel in) {
    this.result= in.readParcelable(QueryAttributeResult.class.getClassLoader());
    this.token= in.readString();
    this.objDescrp = new HashMap<String,String>();
     in.readMap(this.objDescrp, QueryAttributeResult.class.getClassLoader());
  }

  public static final android.os.Parcelable.Creator<QueryAttributeResult> CREATOR = new android.os.Parcelable.Creator<QueryAttributeResult>() {
    @Override
    public QueryAttributeResult[] newArray(int size) {
      return new QueryAttributeResult[size];
    }

    @Override
    public QueryAttributeResult createFromParcel(android.os.Parcel in) {
      return new QueryAttributeResult(in);
    }
  };
