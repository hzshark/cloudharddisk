...
public class DownloadParam implements org.apache.thrift.TBase<DownloadParam, DownloadParam._Fields>, java.io.Serializable, Cloneable, Comparable<DownloadParam>, android.os.Parcelable {
  ...
  public DownloadParam(android.os.Parcel in) {
    //primitive bitfield of type: byte
    __isset_bitfield = in.readByte();

    this.objid= in.readString();
    this.offerset = in.readLong();
    this.reqlen = in.readInt();
    this.type = FTYPE.findByValue(in.readInt());
  }

  public static final android.os.Parcelable.Creator<DownloadParam> CREATOR = new android.os.Parcelable.Creator<DownloadParam>() {
    @Override
    ...
    @Override
    public DownloadParam createFromParcel(android.os.Parcel in) {
      return new DownloadParam(in);
    }
  };
