...
public class FeeInfo implements org.apache.thrift.TBase<FeeInfo, FeeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<FeeInfo>, android.os.Parcelable {
  ...
  public void writeToParcel(android.os.Parcel out, int flags) {
    out.writeString(PrdName);
    out.writeString(Spnumber);
    out.writeString(Cost);
    out.writeString(Smscmd);
  ...
  public FeeInfo(android.os.Parcel in) {
    this.PrdName= in.readString();
    this.Spnumber= in.readString();
    this.Cost= in.readString();
    this.Smscmd= in.readString();
    this.Description= in.readString();
  }

  public static final android.os.Parcelable.Creator<FeeInfo> CREATOR = new android.os.Parcelable.Creator<FeeInfo>() {
    @Override
    ...
    @Override
    public FeeInfo createFromParcel(android.os.Parcel in) {
