...
public class ReqObjparam implements org.apache.thrift.TBase<ReqObjparam, ReqObjparam._Fields>, java.io.Serializable, Cloneable, Comparable<ReqObjparam>, android.os.Parcelable {
  ...
  public ReqObjparam(android.os.Parcel in) {
    this.filename= in.readString();
    this.type = FTYPE.findByValue(in.readInt());
    this.comm= in.readString();
  }

  public static final android.os.Parcelable.Creator<ReqObjparam> CREATOR = new android.os.Parcelable.Creator<ReqObjparam>() {
    @Override
    public ReqObjparam[] newArray(int size) {
      return new ReqObjparam[size];
    }

    @Override
    public ReqObjparam createFromParcel(android.os.Parcel in) {
      return new ReqObjparam(in);
    }
  };
