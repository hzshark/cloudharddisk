              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<BucketInfo>(_list42.size);
                  BucketInfo _elem43;
                  for (int _i44 = 0; _i44 < _list42.size; ++_i44)
                  {
                    _elem43 = new BucketInfo();
                    _elem43.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryBucket_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (BucketInfo _iter45 : struct.success)
            {
              _iter45.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (BucketInfo _iter46 : struct.success)
            {
              _iter46.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<BucketInfo>(_list47.size);
            BucketInfo _elem48;
            for (int _i49 = 0; _i49 < _list47.size; ++_i49)
            {
              _elem48 = new BucketInfo();
              _elem48.read(iprot);
