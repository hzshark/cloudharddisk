...
public class CloudHardDiskService {
  ...
  public interface Iface {
    ...
    public QueryFResult queryFileList(String token, FTYPE type, int start, int excpet_num) throws org.apache.thrift.TException;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.oids = new ArrayList<String>(_list18.size);
                  String _elem19;
                  for (int _i20 = 0; _i20 < _list18.size; ++_i20)
                  {
                    _elem19 = iprot.readString();
                    struct.oids.add(_elem19);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, delObj_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.oids != null) {
          oprot.writeFieldBegin(OIDS_FIELD_DESC);
          {
            ...
            for (String _iter21 : struct.oids)
            {
        ...
        if (struct.isSetOids()) {
          {
            ...
            for (String _iter22 : struct.oids)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.oids = new ArrayList<String>(_list23.size);
            String _elem24;
            for (int _i25 = 0; _i25 < _list23.size; ++_i25)
            {
              _elem24 = iprot.readString();
              struct.oids.add(_elem24);
            }
          }
          struct.setOidsIsSet(true);
        }
