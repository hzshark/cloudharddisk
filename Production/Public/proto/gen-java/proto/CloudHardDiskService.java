              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.odescr = new HashMap<String,String>(2*_map8.size);
                  String _key9;
                  String _val10;
                  for (int _i11 = 0; _i11 < _map8.size; ++_i11)
                  {
                    ...
                    struct.odescr.put(_key9, _val10);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, commitObj_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.odescr != null) {
          oprot.writeFieldBegin(ODESCR_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter12 : struct.odescr.entrySet())
            {
        ...
        if (struct.isSetOdescr()) {
          {
            ...
            for (Map.Entry<String, String> _iter13 : struct.odescr.entrySet())
            {
        ...
        if (incoming.get(2)) {
          {
            ...
            struct.odescr = new HashMap<String,String>(2*_map14.size);
            String _key15;
            String _val16;
            for (int _i17 = 0; _i17 < _map14.size; ++_i17)
            {
              ...
              struct.odescr.put(_key15, _val16);
            }
          }
          struct.setOdescrIsSet(true);
        }
