...
public class BucketListResult implements org.apache.thrift.TBase<BucketListResult, BucketListResult._Fields>, java.io.Serializable, Cloneable, Comparable<BucketListResult>, android.os.Parcelable {
  ...
  public BucketListResult(android.os.Parcel in) {
    this.result= in.readParcelable(BucketListResult.class.getClassLoader());
    this.token= in.readString();
    this.bucketlist = new ArrayList<BucketInfo>();
    in.readTypedList(this.bucketlist, BucketInfo.CREATOR);
  }

  public static final android.os.Parcelable.Creator<BucketListResult> CREATOR = new android.os.Parcelable.Creator<BucketListResult>() {
    @Override
    public BucketListResult[] newArray(int size) {
      return new BucketListResult[size];
    }

    @Override
    public BucketListResult createFromParcel(android.os.Parcel in) {
      return new BucketListResult(in);
    }
  };
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bucketlist = new ArrayList<BucketInfo>(_list32.size);
                BucketInfo _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new BucketInfo();
                  _elem33.read(iprot);
                  struct.bucketlist.add(_elem33);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BucketListResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.bucketlist != null) {
        oprot.writeFieldBegin(BUCKETLIST_FIELD_DESC);
        {
          ...
          for (BucketInfo _iter35 : struct.bucketlist)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetBucketlist()) {
        {
          ...
          for (BucketInfo _iter36 : struct.bucketlist)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.bucketlist = new ArrayList<BucketInfo>(_list37.size);
          BucketInfo _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new BucketInfo();
            _elem38.read(iprot);
            struct.bucketlist.add(_elem38);
          }
        }
        struct.setBucketlistIsSet(true);
      }
