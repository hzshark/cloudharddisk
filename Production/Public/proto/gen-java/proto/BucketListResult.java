            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bucketlist = new ArrayList<BucketInfo>(_list16.size);
                BucketInfo _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new BucketInfo();
                  _elem17.read(iprot);
                  struct.bucketlist.add(_elem17);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BucketListResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.bucketlist != null) {
        oprot.writeFieldBegin(BUCKETLIST_FIELD_DESC);
        {
          ...
          for (BucketInfo _iter19 : struct.bucketlist)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetBucketlist()) {
        {
          ...
          for (BucketInfo _iter20 : struct.bucketlist)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.bucketlist = new ArrayList<BucketInfo>(_list21.size);
          BucketInfo _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new BucketInfo();
            _elem22.read(iprot);
            struct.bucketlist.add(_elem22);
          }
        }
        struct.setBucketlistIsSet(true);
      }
